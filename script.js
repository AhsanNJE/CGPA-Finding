...
function result4() {
  ...
  if (
    ...
    if (_totalMark >= 80 && _totalMark <= 100) {
      document.getElementById("grad3").value = "A+";
      ...
      document.getElementById("grad3").value = "B";
      document.getElementById("point3").value = "3.00";
    } else if (_totalMark >= 40 && _totalMark <= 49) {
      document.getElementById("grad3").value = "C";
      document.getElementById("point3").value = "2.00";
    } else if (_totalMark >= 33 && _totalMark <= 39) {
      document.getElementById("grad3").value = "D";
      document.getElementById("point3").value = "1.00";
    } else if (_totalMark >= 0 && _totalMark <= 32) {
      document.getElementById("grad3").value = "F";
...
function finalResult() {
  if (
    ...
    } else if (_totalPoint >= 4.0 && _totalPoint <= 4.99) {
      document.getElementById("totalgrade").value = "A";
    } else if (_totalPoint >= 3.0 && _totalPoint <= 3.99) {
      document.getElementById("totalgrade").value = "A-";
    } else if (_totalPoint >= 2.0 && _totalPoint <= 2.99) {
      document.getElementById("totalgrade").value = "A-";
    } else if (_totalPoint >= 1.0 && _totalPoint <= 1.99) {
      document.getElementById("totalgrade").value = "A-";
    }
  }
}
